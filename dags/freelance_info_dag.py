...
def freelance_info_job_scraper():
    ...
    def get_page_number_task(ti=None):
        number_of_pages = link_scraper.get_page_number(
            initial_url="https://www.freelance-informatique.fr/offres-freelance"
        )
    ...
    move_loaded_file = GCSToGCSOperator(
        ...
        source_bucket="freelance_info_jobs",
        source_object="{{ ti.xcom_pull(task_ids='page_scraper_task') }}",
        destination_bucket="freelance_info_jobs",
        destination_object="freelance_info/loaded/",
        move_object=True,
    )
